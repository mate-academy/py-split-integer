...
def test_should_split_into_equal_parts_when_value_divisible_by_parts() -> None:
    ...
    ), f"If {value} is divided without the remainder by {number_of_parts}, " \
       "elements should be equal parts"
...
def test_should_return_part_equals_to_value_when_split_into_one_part() -> None:
    ...
    ), "If number of parts is 1, should return part equals to value"
...
def test_parts_should_be_sorted_when_they_are_not_equal() -> None:
    ...
    assert (
        not all(element == elements[0] for element in elements)
        and elements == sorted_elements
