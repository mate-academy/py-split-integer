...
def test_difference_between_max_and_min_should_be_less_than_or_equal_to_one() -> None:
    for value, parts in [(10, 3), (7, 3), (11, 5), (32, 6)]:
        result = split_integer(value, parts)
        assert max(result) - min(result) <= 1, f"Max-min difference in {result} is greater than 1"